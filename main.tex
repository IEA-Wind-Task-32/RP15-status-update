...
\todo[inline]{Are there other documents we should consider / mention, e.g. TR6?}
	...
	The following sections identify the documents that are applicable to the lifecycle of a wind lidar deployment:
	
	\begin{itemize}
		\item \S 1 Characterising wind lidar
	...
	\section{Characterising remote sensing devices}
	...
	\todo[inline]{Do we want numbered headings for easy reference?}
