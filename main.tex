...
... to document the steps required to collect high-quality, well-documented remote sensing data for use in wind resource assessments on land. 
	...
	The use case considered here is the same as was stated in the preface of RP15:

	\begin{shadequote}[r]{RP15 (2013)}
	... ground-based, fixed scan geometry, vertically-profiling wind remote sensing using lidar and sodar for the resource assessment phase of an on-shore wind farm development. Lidar and sodar that use these methods are referred to generically in the document as remote sensing devices, or RSD.''
	\end{shadequote}

	We limit our update solely to wind lidar.
		
	
	\section*{Relevant documents}
	
	The \href{https://github.com/IEA-Wind-Task-32/RP15-Ground-Based-Remote-Sensing-for-Wind-Resource-Assessment/releases/tag/1.0}{2013 IEA Wind Recommended Practices document} provides specific guidance as ``Recommended Practices'' (e.g., RP1) and informative notes (e.g. Note 1) about how to use remote sensing. There were 41 RPs and 22 notes in total, covering many different aspects of the remote sensing lifecycle. These RPs represented the community's perceptions of how to do things, and were not always based on evidence, and so were called ``recommended practices'', not a standard. 
